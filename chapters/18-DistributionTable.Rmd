...
\hline
  ~~p_0 &(1-q)^m \\
\hline
  \small{\text{Probability mass function}} & {m \choose k}q^k(1-q)^{m-k} \\
  ~~p_k & \\
\hline
...
\hline
  \text{Function Name} & \text{R Command} \\
\hline
  \small{\text{Probability mass function}} & \text{dbinom}(x=, size=m, prob=q) \\
\hline
  \small{\text{Distribution function}} & \text{pbinom}(p=, size=m, prob=q) \\
\hline
  \small{\text{Quantile function}} & \text{qbinom}(q=, size=m, prob=q) \\ 
\hline
  \small{\text{Random sampling function}} & \text{rbinom}(n=, size=m, prob=q) \\
\hline
\end{array}
\end{matrix}
$$
...
\hline
  \small{\text{Probability mass function}} & \frac{{m \choose k}q^k(1-q)^{m-k}}{1-(1-q)^m} \\
  ~~p^T_k & \\
\hline
...
\hline
  \text{Function Name} & \text{R Command} \\
\hline
  \small{\text{Density function}} & \text{dpareto}(x=, shape=\alpha, scale=\theta) \\
\hline
  \small{\text{Distribution function}} & \text{ppareto}(p=, shape=\alpha,scale=\theta) \\
\hline
  \small{\text{Quantile function}} & \text{qpareto}(q=, shape=\alpha,scale=\theta) \\ 
\hline
  \small{\text{Random sampling function}} & \text{rpareto}(n=, shape=\alpha,scale=\theta) \\
\hline
\end{array}
\end{matrix}
$$
...
X=1:1000
plot(x=X,y=levpareto(X,3,200),col="red",type="l",xlab="x values", ylim = c(0,100),
