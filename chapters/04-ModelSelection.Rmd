...
```{r image2, echo=FALSE, fig.cap="",fig.align='center', out.width = '100%'}
knitr::include_graphics("images/4.3.1.1.png")
```
...
```{r image2, echo=FALSE, fig.cap="",fig.align='center', out.width = '100%'}
knitr::include_graphics("images/4.3.1.1-1.png")
```

Dan fungsi log-kemungkinan adalah

```{r image2, echo=FALSE, fig.cap="",fig.align='center', out.width = '100%'}
knitr::include_graphics("images/4.3.1.1-2.png")
```
...
knitr::include_graphics("example4.3.png")
```
...
knitr::include_graphics("table4-1.png")
```
...
knitr::include_graphics("example4.3.4.png")
```
...
knitr::include_graphics("example4.3.6.png")
```
...
```{r image7, echo=FALSE, fig.cap="",fig.align='center', out.width = '100%'}
knitr::include_graphics("4.4.1.png")
```
...
dalam hal ini $\pi(\cdot)$ disebut prior yang tidak tepat.

Distribusi Model. Distribusi hasil diberi nilai asumsi θ dikenal sebagai model distribusi dan dilambangkan sebagai $f(x | \boldsymbol \theta) = f_{X|\boldsymbol \theta} (x|\boldsymbol \theta )$ Ini adalah fungsi massa atau kerapatan frequentist yang biasa. Ini hanyalah kemungkinan dalam konteks frequentist dan karenanya juga nyaman untuk menggunakan ini sebagai deskriptor untuk distribusi model.
...
Salah satu cara untuk meringkas distribusi adalah dengan menggunakan pernyataan tipe interval kepercayaan . Untuk meringkas distribusi parameter posterior , interval $[a,b]$ dikatakan sebagai $100(1-\alpha)\%$ interval kredibilitas untuk θ jika
...
Contoh:
* Dalam portofolio risiko, setiap pemegang polis dapat memiliki paling banyak satu klaim per tahun.
* Probabilitas klaim untuk pemegang polis selama setahun adalah Q
* Kepadatan sebelumnya adalah

$$
\pi(q) = q^3/0.07, \ \ \ 0.6 < q < 0.8
$$
Pemegang polis yang dipilih secara acak memiliki satu klaim pada Tahun 1 dan nol klaim pada Tahun 2. Untuk pemegang polis ini, hitung probabilitas posterior bahwa
...
Kepadatan posterior sebanding dengan produk dari fungsi kemungkinan dan kepadatan sebelumnya. Dengan demikian,

$$
\pi(q|1,0) \propto f(1|q)\ f(0|q)\ \pi(q) \propto q(1-q)q^3 = q^4-q^5
$$

Untuk mendapatkan kerapatan posterior yang tepat, kami mengintegrasikan fungsi di atas pada jangkauannya (0.6, 0.8)
...
>>>>>>> 0e0893ff56e59ef003e40a0dc3d0386e3e1d7446
